...
export default async function PlayerPage({ params, searchParams }: PlayerPageProps) {
  ...
  if (type === 'movie') {
    ...
    embedSrc.p7 = `https://2embed.stream/movie/${tmdbId}`;
  } else {
    ...
    embedSrc.p7 = `https://2embed.stream/tv/${tmdbId}/${seasonNumber}/${episodeNumber}`;
  ...
  return (
    <PageContainer>
      ...
      <Tabs defaultValue={selectedPlayer} className="w-full">
        <TabsList className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3 md:gap-4 max-w-4xl mx-auto mb-6 bg-transparent p-0">
